                ...
                >
                  ...
                  >
                    <div class="dropdown-menu-header p-3">
                      <h5 class="dropdown-menu-title mb-0">Carrito</h5>
                    </div>
                    <!--//dropdown-menu-title-->
                      ...
                      <div class="item p-3">
                        ...
                        >
                          <div class="col-auto">
                            <img
                              class="profile-image"
                              src="../assets/images/profiles/coatex.jpg"
                              alt=""
                            />
                          </div>
                          <!--//col-->
        ...
        <div class="sidepanel-inner d-flex flex-column">
          ...
          <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
              <li v-show="this.$store.state.user.is_admin" class="nav-item">
                <router-link
                  class="nav-link"
                  to="/consulta"
              ...
              <li v-show="!this.$store.state.user.is_admin" class="nav-item">
                ...
                >
                  ...
                  <span class="nav-link-text">Perfil de Usuario</span> </router-link
                ><!--//nav-link-->
              </li>
              <!--//nav-item-->
              <li v-show="!this.$store.state.user.is_admin" class="nav-item">
                ...
                >
                  ...
                  <span class="nav-link-text">Historial Clínico</span> </router-link
                ><!--//nav-link-->
              </li>
              <!--//nav-item-->
              <li class="nav-item">
