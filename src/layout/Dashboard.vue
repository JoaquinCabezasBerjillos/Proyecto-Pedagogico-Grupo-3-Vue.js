                        ...
                        <div class="item p-3">
                          ...
                          >
                            <div class="col-auto">
                              <img
                                class="profile-image"
                                src="../assets/images/profiles/coatex.png"
                                alt=""
                              />
                            </div>
                            <!--//col-->
              ...
              <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                <li class="nav-item">
                  ...
                  <a class="nav-link active" href="index.html">
                    ...
                    <span class="nav-link-text">Bienvenida</span> </a
                  ><!--//nav-link-->
                </li>
                <!--//nav-item-->
                <li class="nav-item">
                  ...
                  <a class="nav-link" href="docs.html">
                    ...
                    <span class="nav-link-text">Historial</span> </a
                  ><!--//nav-link-->
                </li>
                <!--//nav-item-->
                <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <a class="nav-link" href="charts.html">
                    ...
                    <span class="nav-link-text">Por si acaso</span> </a
                  ><!--//nav-link-->
                </li>
                <!--//nav-item-->
