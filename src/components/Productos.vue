      ...
      <div class="portfolio-items">
        <div class="col-sm-3 col-md-3 col-lg-4 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../assets/img/Alimentacion.jpg" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Alimentación</h4>
                <small>Gran variedad de alimentación para tu mascota</small>
                <div class="clearfix"></div>
              </div>
              <img src="../assets/img/Alimentacion.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-3 col-md-3 col-lg-4 app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../assets/img/Medicina4.jpg" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Medicamentos</h4>
                <small>Para cuidar la salud de tu mascota</small>
                <div class="clearfix"></div>
              </div>
              <img src="../assets/img/Medicina4.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-3 col-md-4 col-lg-4 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="../assets/img/Accesorios3.jpg" rel="prettyPhoto">
              ...
              <img src="../assets/img/Accesorios3.jpg" class="img-responsive" alt="Project Title"> </a> </div>
              </div>
          </div>
        </div>
      </div>
