<template>
    <div class="app-content pt-3 p-md-3 p-lg-4">
      <div class="container-xl">
        <h1 class="app-page-title">Centro Veterinario Victoria- Sevilla</h1>

         <div
          class="app-card alert alert-succes shadow-sm mb-4 border-left-decoration"
          role="alert"
        > 
          <div class="inner">
            <div class="app-card-body p-3 p-lg-4">
              <h3 class="alert-heading">Bienvenido a su rincón, Andrés!</h3>
