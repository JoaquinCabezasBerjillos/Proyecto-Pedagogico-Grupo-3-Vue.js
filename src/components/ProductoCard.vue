    ...
    <div class="app-card-body p-3 has-card-actions">
      ...
      <div class="app-doc-meta">
        <ul class="list-unstyled mb-0">
          <li>
              <span class="text-muted">Precio:</span> {{ producto.precio }}</li>

          <li>
              <span class="text-muted">Descripción:</span> {{ producto.descripcion }}</li> 
        </ul>
      </div>
      <!--//app-doc-meta-->
      ...
      <div class="app-card-actions">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <router-link class="dropdown-item" :to="{ nombre: 'ProductoEdit', params: {id: producto.id}}"
                ><svg
                  width="1em"
                  height="1em"
                  viewBox="0 0 16 16"
